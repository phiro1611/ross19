...
\cellcolor[HTML]{C0C0C0}{\color[HTML]{000000} Inception V4} & wet & 95.1\% & 299x299 & 107.7 MB \\ \hline
\cellcolor[HTML]{C0C0C0}{\color[HTML]{000000} Mobilenet V2 1.0} & 3470000 \cite{mobilenetspecs}& 90.6\% & 224x224 & 14.0 MB \\ \hline
\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}Mobilenet V2 1.0\\ quantized\end{tabular} & 3470000 \cite{mobilenetspecs}& 89.9\% & 224x224 & 3.4 MB \\ \hline
\end{tabular}
\end{table}


\subsection{Android Benchmark Application}
In order to perform the inference process on the edge devices we developed a Android benchmark application written in Kotlin. 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{./Bilder/preprocessing.jpg}
