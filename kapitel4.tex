...
%eingehen darauf dass network constant bleibt und nicht der entscheidene faktor bei latency ist.

%%cloud preprocessing bigger images higher variance
%vergelichen
%kleine images schneller auf der cloud, sonst edge
...
\begin{subfigure}[b]{0.95\textwidth}
   ...
   \caption{Cloud Preprocessing}
   \label{fig:CloudInferenceratioCloudrelative} 
\end{subfigure}
...
\begin{subfigure}[b]{0.95\textwidth}
   ...
   \caption{Edge Preprocessing}
   \label{fig:CloudInferenceRatioEdgerelative}
\end{subfigure}
