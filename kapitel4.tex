...
\emph{
\begin{itemize}
    \item Cloud Preprocessing in comparison to edge preprocessing causes:
    \begin{itemize}
    ...
    \end{itemize}
    \item Network connection is not a decisive factor in our experimentation environment
    \item In comparison to InceptionV4 MobileNetV2 leads to:
    \begin{itemize}
        \item $xyz\times$ faster $Latency_{inference}$
        \item $xyz\times$ more $Memory_{inference}$
    \end{itemize}
