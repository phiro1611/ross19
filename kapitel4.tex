...
This module is a combination of three layers, started by a conv2d, followed by a depthwise convolution and lastly again a conv2d layer.
While the first conv2d layer increases the channel dimension of the input, the second conv2 decreases this dimension again.

The bottleneck module can be implemented very memory efficient, thus particularly fit for edge inference.

Figure \ref{fig:MobileNetArchi} displays the design of the model, with 
...
\end{subfigure}%
\begin{subfigure}[t]{0.47\textwidth}
   %%CAREFUL WITH THIS ARCHITECTURE
