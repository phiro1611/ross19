...
This effect can be observed across all tested models, but especially on the InceptionV4 network, as this large model especically benefits from the optimized operations.
...
Edge inference consumes substantially more than the cloud inference counter-parts with InceptionV4 consuming $1289$MB for a batch size of $16$ and $2132.3$MB for batch size $32$.
