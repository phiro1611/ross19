...
\draw  [dash pattern={on 4.5pt off 4.5pt}] (46.5,146) -- (465.5,146) -- (465.5,294) -- (46.5,294) -- cycle ;

\draw (208,185) node  [align=left] {Image};
\draw (212,234) node  [align=left] {Prediction};
\draw (260,121) node  [align=left] {{\large Edge}};
\draw (371,215) node  [align=left] {{\LARGE TensorFlow}\\{\LARGE  \ \ \ \ \ Lite}};
