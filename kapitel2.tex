...
In the case the Android experiments 480x640 jpeg images get captured that get resized, cropped and normalized during their preprocessing step.
...
The authors conclude "that CNNs for mobile computer vision have significant latency–throughput trade-offs, but the behavior is very complex" caused by a number of different factors affecting the performance.
\subsection{MLPerf}
