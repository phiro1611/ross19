...
Similar to Guo, the authors of this paper study the inference performance of CNNs on both edge devices and cloud backend, but use different hardware devides and frameworks as can be seen in table \ref{frameworks_hardware_2}. 
\begin{table}[H]
\centering
