...
The model loading time (1.\,Load model), the time needed to resize the image into $224\times224$ bitmaps(2.\,Rescale bitmap), the time needed to upload the bitmap to the server in case of cloud inference (3.\,Upload bitmap) and the inference time (4.\,Compute probability).
