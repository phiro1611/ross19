...
In the case of the Android experiments $480\times640$ \emph{JPG} images get captured. Afterwards these images get resized, cropped and normalized during the preprocessing step before getting fed to the neural networks.
