...
We conducted the experiments in multiple sessions, where each session consists of around  $100$ experiments distributed over about two hours, thus preventing the results to be skewed by thermal throttling.
...
Note that this section only covers the results for a batch size of one, for the results of larger batch sizes please refer to subsection \ref{chap:resultsBatchSize}.
...
\begin{lstlisting}[label = network, caption = Network connection test to cloud-backend with iperf]
[ID] Interval           Transfer     Bandwidth
[ 4] 0.00-1.01   sec  18.3 MBytes   152 Mbits/sec                  
[ 4] 1.01-2.02   sec  15.7 MBytes   130 Mbits/sec                  
[ 4] 2.02-3.03   sec  16.8 MBytes   138 Mbits/sec                  
[ 4] 3.03-4.01   sec  15.8 MBytes   136 Mbits/sec                  
[ 4] 4.01-5.00   sec  16.9 MBytes   142 Mbits/sec                  
[ 4] 5.00-6.01   sec  16.5 MBytes   137 Mbits/sec                  
[ 4] 6.01-7.04   sec  17.0 MBytes   139 Mbits/sec                  
[ 4] 7.04-8.02   sec  15.7 MBytes   134 Mbits/sec                  
[ 4] 8.02-9.01   sec  16.7 MBytes   142 Mbits/sec                  
[ 4] 9.01-10.03  sec  16.7 MBytes   138 Mbits/sec                  
- - - - - - - - - - - - - - - - - - - - - - - - -
[ID] Interval           Transfer     Bandwidth
[ 4] 0.00-10.03  sec   166 MBytes   139 Mbits/sec     sender
[ 4] 0.00-10.03  sec   163 MBytes   137 Mbits/sec     receiver
...
For InceptionV4 and $0.05$MP images cloud inference with cloud preprocessing is the fastest inference method with a mean of $94.9$ms, followed by cloud inference with edge inference ($180.4$ms) and cloud inference with edge preprocessing ($235.9$ms).
...
These factors now can be used to generate a multiple linear regression model, which aims to predict the $Latency_{total}$.
We decided to use multiple linear regression with ordinary least squares for this task, as we think, based on the previously evaluated benchmarks, that there is a linear relationship between the latency and the above mentioned factors.
...
Based on the previous defined regression formulas, we can now use the generated benchmark to fit those models using the ordinary least squares approach.
...
\begin{lstlisting}[caption = $\hat{Y}_{Cloud_{CloudPrepro}}$ Summary, escapeinside={(*}{*)}]
                            OLS Regression Results                            
==============================================================================
Dep. Variable:              (*$Latency_{total}$*)   R-squared:                       0.898
Model:                            OLS   Adj. R-squared:                  0.896
Method:                 Least Squares   F-statistic:                     451.0
Date:                Thu, 07 Mar 2019   Prob (F-statistic):           2.23e-51
Time:                        15:31:05   Log-Likelihood:                -690.49
No. Observations:                 105   AIC:                             1387.
Df Residuals:                     102   BIC:                             1395.
Df Model:                           2                                         
Covariance Type:            nonrobust                                         
================================================================================
                  coef      std err       t        P>|t|      [0.025      0.975]
--------------------------------------------------------------------------------
Intercept      167.4806     16.804      9.967      0.000     134.149     200.812
MobileNetV2     25.9052     19.148      1.353      0.179     -12.075      63.885
InceptionV4    141.5754     19.152      7.392      0.000     103.588     179.562
ImageSize     9.176e-05   3.07e-06     29.924      0.000    8.57e-05    9.78e-05
==============================================================================
Omnibus:                       25.299   Durbin-Watson:                   1.886
Prob(Omnibus):                  0.000   Jarque-Bera (JB):               46.683
Skew:                           0.990   Prob(JB):                     7.29e-11
Kurtosis:                       5.599   Cond. No.                     1.23e+18
==============================================================================
\end{lstlisting}
