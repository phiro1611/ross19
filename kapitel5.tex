...
All models are trained on the ImageNet dataset consisting of 1001 image classes (1000 image classes + 1 class for unknown image classes).
...
\begin{itemize}
    ...
    \begin{itemize}
        \item $10\times$ more $Latency_{preprocessing}$
...
Each plot in this section contains five subplots, one for each image size, the x-axis contains the deep learning model, while the y-axis displays the various performance metrics. 
