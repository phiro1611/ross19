...
In \cite{201468} Crankshaw et al. present a framework for deploying machine learning models at the cloud.
The framework is characterized by low-latency, adaptability, scalability?
